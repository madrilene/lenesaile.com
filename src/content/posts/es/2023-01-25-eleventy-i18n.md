...
{% aside %} Ten en cuenta que desde entonces he actualizado el repositorio para utilizar Eleventy 3.0 y ESM, por lo que algunas cosas han cambiado ligeramente. {% endaside %}
