...
{% aside %} Beachte, dass ich das Projekt inzwischen aktualisiert habe, um Eleventy 3.0 und ESM zu verwenden, so dass sich einige Dinge leicht geändert haben. {% endaside %}
