...
I applied this to the last example with the empty placeholders (I kept the Josh's dashed lines to make the difference to the previous solution more visible):
