...
The magic of subgrid is "inheriting" the superior grid track for their own children. **Let's activate subgrid!**
...
This creates a linear gradient for the `background-image` property, using a repeating pattern of a 1-pixel blue line against a transparent background, and covering 24.95% of the container's width. Sorry for that completely random integer.
