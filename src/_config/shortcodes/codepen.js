...
export const codepen = (content, url, tabs = 'html,result', theme = 'default', height = '100%') => {
  ...
  style="box-sizing: border-box; display: flex; flex-direction: column; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
      ...
      <a href="${url}"><img eleventy:ignore style="max-width: 100%;box-shadow: 1px 1px 5px #999;" src="${url}/image/large.png" /></a>
      ${contentHtml}
  </div>`;
  return markup;
};
