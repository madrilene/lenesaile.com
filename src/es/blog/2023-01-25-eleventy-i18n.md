...
En el momento de escribir este artículo, Eleventy 2.0 está en [versión beta](https://www.11ty.dev/blog/eleventy-v2-beta/) y es sólo cuestión de días que la nueva versión mayor sea lanzada oficialmente. Así que comprueba qué versión está disponible actualmente en el [repositorio oficial](https://github.com/11ty/eleventy/).
...
Si quieres automatizar esto un poco más y hacerlo más intuitivo de usar, aquí hay una solución inteligente que encontré en el [Eleventy Base Blog](https://github.com/11ty/eleventy-base-blog/tree/v2), que incluirá entradas de blog internacionalizadas una vez que Eleventy 2.0 sea lanzado oficialmente.
...
Sin embargo, sólo parece funcionar si no tocas los permalinks, por eso no lo estoy utilizando por ahora.
