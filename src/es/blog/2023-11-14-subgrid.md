...
{% codepen "https://codepen.io/madrilene/pen/xxMLQQr", "resultado" %}
...
Eso es establecer un gradiente lineal para la propiedad `background-image`, creando un patrón repetitivo de una línea azul de 1 píxel sobre un fondo transparente, y cubriendo el 24,95% del ancho del contenedor. Perdón por el número entero aleatorio.

{% codepen "https://codepen.io/madrilene/pen/ExrvBYa", "result" %}
subgrid con lineas: linear-gradient
{% endcodepen %}

Es hacky, buggy y ligeramente fuera, pero lo suficientemente bueno por ahora. Estoy bastante seguro de que todavía voy a cambiarlo, ya que no produce un buen resultado en todos los viewport.

Esta no es una solución satisfactoria - Espero que alguien va a venir con una idea mejor y hágamelo saber acerca de él 😬

## Donde aprendí subgrid

Mi compañero se rió cuando me vio sentado frente al ordenador con un libro técnico (old school). "[CSS - The Definitive Guide](https://www.oreilly.com/library/view/css-the-definitive/9781098117603/)" es en realidad donde primero miro cuando quiero aprender o saber algo sobre CSS con más detalle. Hay más de 80 páginas sólo sobre diseño del grid, y lo recomiendo encarecidamente.
