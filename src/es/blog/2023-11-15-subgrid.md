...
Se posicionan de forma absoluta, abarcando toda la altura de su padre, con una anchura de 1px y un fondo azul. El índice z se establece en -1, colocándolos detrás de su padre.
...
En su lugar, recomienda colocar elementos vacíos en el grid, ya que cualquier cambio en las posiciones actuales de los hijos de `<article>` en el grid puede hacer desaparecer las líneas.
...
Tomé la idea de Roma e implementé los marcadores de posición en otro aún codepen, y también añadí una "media query" para los elementos colocados en el grid, para hacerlos abarcar todo el ancho en dispositivos móviles (y hacer que las líneas funcionen también viewports pequeños).

{% codepen "https://codepen.io/madrilene/pen/NWowaov", "result" %}

Inicio de CodePen

subgrid con líneas: pseudo-elementos con móvil
