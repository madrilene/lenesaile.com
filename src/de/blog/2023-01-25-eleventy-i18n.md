...
description: 'In diesem Artikel, den ich zusammen mit einem Lightning Talk bei TheJam.dev 2023 veröffentliche, erkläre ich, wie Internationalisierung mit Eleventy 2.0 funktioniert und baue ein einfaches Starterprojekt auf.'
category: blogpost
key: 'eleventyi18n'
date: 2023-01-25
lastEdit:
...
Zum Zeitpunkt der Veröffentlichung des Artikels (Ende Januar 2023) befindet sich Eleventy 2.0 in der [Beta-Phase](https://www.11ty.dev/blog/eleventy-v2-beta/) und es ist nur noch eine Frage von Tagen, bis die neue Version veröffentlicht wird. Prüfe also, welche Version derzeit im [offiziellen Repository](https://github.com/11ty/eleventy/) verfügbar ist.
...
Es gibt noch einen weiteren Filter, über den wir noch nicht gesprochen haben.
...
Es scheint aber nur zu funktionieren, wenn man die Permalinks nicht verändert, deshalb mache ich im Moment keinen Gebrauch davon.
